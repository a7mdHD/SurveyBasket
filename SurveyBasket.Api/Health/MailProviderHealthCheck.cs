...
public class MailProviderHealthCheck(IOptions<EmailSettings> mailSettings) : IHealthCheck
{
    ...
    public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
    {
		try
		{
            ...
            smtp.Authenticate(_mailSettings.Email, _mailSettings.Password, cancellationToken);
